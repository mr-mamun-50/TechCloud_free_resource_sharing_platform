...
<!-- Custom js -->
<script type="text/javascript" src="{{ asset('public/adm') }}/assets/pages/dashboard/custom-dashboard.min.js">
</script>
...
<!-- DataTables  & Plugins -->
<script src="{{ asset('public/adm') }}/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="{{ asset('public/adm') }}/plugins/datatables-bs4/js/dataTables.bootstrap4.min.js"></script>
<script src="{{ asset('public/adm') }}/plugins/datatables-responsive/js/dataTables.responsive.min.js"></script>
<script src="{{ asset('public/adm') }}/plugins/datatables-responsive/js/responsive.bootstrap4.min.js"></script>
<script src="{{ asset('public/adm') }}/plugins/datatables-buttons/js/dataTables.buttons.min.js"></script>
<script src="{{ asset('public/adm') }}/plugins/datatables-buttons/js/buttons.bootstrap4.min.js"></script>
<script src="{{ asset('public/adm') }}/plugins/jszip/jszip.min.js"></script>
<script src="{{ asset('public/adm') }}/plugins/pdfmake/pdfmake.min.js"></script>
<script src="{{ asset('public/adm') }}/plugins/pdfmake/vfs_fonts.js"></script>
<script src="{{ asset('public/adm') }}/plugins/datatables-buttons/js/buttons.html5.min.js"></script>
<script src="{{ asset('public/adm') }}/plugins/datatables-buttons/js/buttons.print.min.js"></script>
<script src="{{ asset('public/adm') }}/plugins/datatables-buttons/js/buttons.colVis.min.js"></script>
<!-- Summernote -->
